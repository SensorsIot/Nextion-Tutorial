...
//  Declare a hotspot object [page id:0,component id:5, component name: "progressBurj"].
NexProgressBar progressBurj = NexProgressBar(0, 5, "progressBurj");

//   Declare a button object [page id:0,component id:5, component name: "b1"].
NexButton buttonNext = NexButton(0, 6, "buttonNext");

//   Declare a hotspot object [page id:1,component id:2, component name: "spotBurj"].
NexHotspot spotBurj = NexHotspot(1, 2, "spotBurj");
...
/*
   Burj hotspot callback function.
*/
void spotBurjPushCallback(void *ptr)
{
  dbSerialPrintln("spotBurjPushCallback");
  page0.show();
}
...
*/
void buttonNextPushCallback(void *ptr)
{
...
void setup(void)
{
  ...
  /* Register the pop event callback function of the current button1 component. */
  spotBurj.attachPush(spotBurjPushCallback);

  /* Register the pop event callback function of the current button1 component. */
  buttonNext.attachPush(buttonNextPushCallback);
